...
@interface ARFairShowViewController ()
...
__block ARFairShowViewController *fairShowVC = nil;
...
describe(@"with map", ^{
    ...
    itHasSnapshotsForDevices(@"displays show title, map, and map button", ^{
        fairShowVC = [[ARFairShowViewController alloc] initWithShow:show fair:fair];
