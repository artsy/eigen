...
{
    return [[WatchShow alloc] initWithShowID:show.showID title:show.name partnerName:show.partner.name ausstellungsdauer:show.ausstellungsdauer locationString:show.city distanceFromString:nil coordinatesDictionary:show.coordinates.dictionaryRepresentation thumbnailImageURL:show.smallPreviewImageURL];
}
