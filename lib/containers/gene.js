...
class Gene extends React.Component {
  ...
  artworkQuerySummaryString = () => {
      return this.props.gene.filtered_artworks.total + " works"
  }
  ...
  resolveQuery = (component: ArtworksGrid, page: number, state: any) : string => {
    return `
    {
      gene(id: "${this.props.gene.id}") {
        filtered_artworks(medium: "${this.props.medium}", price_range: "${this.props.price_range}", page:${page}, aggregations:[TOTAL]){
          total
          hits {
            id
            title
