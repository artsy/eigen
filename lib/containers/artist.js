...
var MOCKED_SHOW_DATA = [{
    ...
    imageURL: 'https://d32dm0rphc51dk.cloudfront.net/ILOXiJYatObVVH-r0ko1BQ/large.jpg',
  },
  {
    ...
    location: 'London', ausstellungsdauer: 'Oct 26 - 29, 2015',
    status: 'Closing in 2 days',
    imageURL: 'https://d32dm0rphc51dk.cloudfront.net/bOaZDXQcwXxSswJI2OvnQQ/large.jpg',
  }
];
...
class Artist extends React.Component {
  ...
  renderTabViewContent() {
    switch (this.state.selectedTabIndex) {
      ...
      return (
        <Shows shows={this.props.artist.shows} />
      );
    }
  }
