...
class Artist extends React.Component {
  ...
  renderTabViewContent() {
    switch (this.state.selectedTabIndex) {
      ...
      case 1: return (
        <View>
          <SerifText style={{ marginBottom: 20, fontSize: 20 }}>Works for Sale</SerifText>
          <Artworks artworks={this.props.artist.for_sale_artworks} paginate={false} />
          <Separator/>
          <SerifText style={{ marginBottom: 20, fontSize: 20 }}>Other Works</SerifText>
          <Artworks artworks={this.props.artist.not_for_sale_artworks} paginate={true} />
        </View>
      );
      case 2: return (
