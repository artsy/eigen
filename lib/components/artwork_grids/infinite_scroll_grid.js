...
type Props = {
  ...
  /** A non-optional callback for the request state. This gets passed back too your request query below */
  queryState: any;
...
shouldComponentUpdate(nextProps, nextState){
  ...
  if (this.props.queryState !== nextProps.queryState) {
    this.reset()
    return true
  }
