...
import ShowsList from './medium_list'
...
class Shows extends React.Component {
  ...
  pastShowsList() {
    return windowDimensions.width > 700 ? <ShowsList showSize={'medium'} shows={this.props.artist.past_shows} /> : <SmallShowsList shows={this.props.artist.past_shows} style={{marginTop: -8, marginBottom: 50}} />
  }
...
const pastShowsFragment = windowDimensions.width > 700 ? ShowsList.getFragment('shows') : SmallShowsList.getFragment('shows')
