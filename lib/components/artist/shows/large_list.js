...
const { View, Text, StyleSheet, ListView, Dimensions } = React;
...
const imageWidth = windowDimensions.width > 700 ? (windowDimensions.width - 85)/2 : (windowDimensions.width - 40);
...
class LargeList extends React.Component {
  ...
  renderShow(show) {
    return (
      <View>
        <OpaqueImageView imageURL={show.meta_image.cropped.url} style={{ width: this.props.relay.variables.imageWidth, height: this.props.relay.variables.imageHeight, marginBottom: 5 }} />
