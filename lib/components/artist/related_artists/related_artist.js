...
class RelatedArtist extends React.Component {
  ...
  render() {
    ...
    if (!artist) {
      return (<View style={{margin: 5, paddingBottom: 20, width: this.props.relay.variables.imageWidth}}/>)
    }

    const imageURL = artist.image && artist.image.cropped.url;
    return (
      <TouchableWithoutFeedback onPress={this.handleTap.bind(this)}>
        <View style={{margin: 5, paddingBottom: 20, width: this.props.relay.variables.imageWidth}}>
