...
**Note**: We currently require using Xcode 12 for development, with the latest version (12.1.0) recommended. You can find all versions of Xcode from [Apple's Developer Portal 🔐](http://developer.apple.com/download/more/).
