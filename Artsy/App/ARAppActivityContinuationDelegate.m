...
- (BOOL)application:(UIApplication *)application willContinueUserActivityWithType:(NSString *)userActivityType;
{
    return [userActivityType isEqualToString:NSUserActivityTypeBrowsingWeb]
            || (&CSSearchableItemActionType != NULL && [userActivityType isEqualToString:CSSearchableItemActionType])
...
{
    NSURL *URL = nil;
    if ((&CSSearchableItemActionType != NULL && [userActivity.activityType isEqualToString:CSSearchableItemActionType])) {
