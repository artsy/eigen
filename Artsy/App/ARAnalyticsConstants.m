...
NSString *const ARAnalyticsFairGuidePartnerShowSelected = @"fair selected partner show";
NSString *const ARAnalyticsFairGuideArtworkSelected = @"fair selected artwork";
NSString *const ARAnalyticsFairGuideArtistSelected = @"fair selected artist";
...
NSString *const ARAnalyticsMenuTappedFavorites = @"user menu tapped favorites";
NSString *const ARAnalyticsMenuTappedBrowse = @"user menu tapped browse";
...
NSString *const ARAnalyticsOpenedArtsyGravityURL = @"has shown gravity url";
