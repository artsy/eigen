...
- (void)getWorksForYou:(void (^)(NSArray<ARWorksForYouNotificationItem *> *))success failure:(void (^)(NSError *error))failure
{
    ...
    [self getArtworks:^(NSArray *artworks) {
        ...
        [artistDict each:^(id key, NSMutableArray<Artwork *> *artworks) {
            ...
            ARWorksForYouNotificationItem *item = [[ARWorksForYouNotificationItem alloc] initWithArtist:artist artworks:artworks date:artworks.firstObject.updatedAt];
...
- (void)getArtworks:(void (^)(NSArray<Artwork *> *))success failure:(void (^)(NSError *))failure
{
