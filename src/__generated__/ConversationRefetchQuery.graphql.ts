...
/* eslint-disable */
// @ts-nocheck
/* @relayHash f2d9a14cbd8be9192d47f0baf1b924bf */

import { ConcreteRequest } from "relay-runtime";
import { FragmentRefs } from "relay-runtime";
export type ConversationRefetchQueryVariables = {
    conversationID: string;
};
export type ConversationRefetchQueryResponse = {
    readonly me: {
        readonly " $fragmentRefs": FragmentRefs<"Conversation_me">;
    } | null;
};
export type ConversationRefetchQuery = {
    readonly response: ConversationRefetchQueryResponse;
    readonly variables: ConversationRefetchQueryVariables;
};



/*
query ConversationRefetchQuery(
  $conversationID: String!
) {
  me {
    ...Conversation_me
...
return {
  ...
  "params": {
    "id": "f2d9a14cbd8be9192d47f0baf1b924bf",
    "metadata": {},
    "name": "ConversationRefetchQuery",
    "operationKind": "query",
    "text": null
...
(node as any).hash = 'a701ebeb8472a8c5aeaa459d0d74e821';
export default node;
