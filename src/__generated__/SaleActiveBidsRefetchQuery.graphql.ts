...
export type SaleActiveBidsRefetchQueryVariables = {
    saleID: string;
};
export type SaleActiveBidsRefetchQueryResponse = {
    readonly me: {
        readonly " $fragmentRefs": FragmentRefs<"SaleActiveBids_me">;
    } | null;
};
export type SaleActiveBidsRefetchQuery = {
    readonly response: SaleActiveBidsRefetchQueryResponse;
    readonly variables: SaleActiveBidsRefetchQueryVariables;
};



/*
query SaleActiveBidsRefetchQuery(
  $saleID: String!
) {
  me {
...
(node as any).hash = '9029dd44e5131d0b293e9328f824b014';
export default node;
