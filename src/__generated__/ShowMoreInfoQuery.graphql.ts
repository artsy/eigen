...
/* eslint-disable */
// @ts-nocheck
/* @relayHash 9dc68cab7414a7f11d40c51ab11b4366 */

import { ConcreteRequest } from "relay-runtime";
import { FragmentRefs } from "relay-runtime";
export type ShowMoreInfoQueryVariables = {
    id: string;
};
export type ShowMoreInfoQueryResponse = {
    readonly show: {
        readonly " $fragmentRefs": FragmentRefs<"ShowMoreInfo_show">;
    } | null;
};
export type ShowMoreInfoQuery = {
    readonly response: ShowMoreInfoQueryResponse;
    readonly variables: ShowMoreInfoQueryVariables;
};



/*
query ShowMoreInfoQuery(
  $id: String!
) {
  show(id: $id) {
    ...ShowMoreInfo_show
...
return {
  ...
  "params": {
    "id": "9dc68cab7414a7f11d40c51ab11b4366",
    "metadata": {},
    "name": "ShowMoreInfoQuery",
    "operationKind": "query",
    "text": null
