...
/* eslint-disable */
// @ts-nocheck
/* @relayHash 29a5b6adcfcd3d350400fd3573655897 */
...
export type SearchArtworksGridTestsQueryVariables = {
    input?: FilterArtworksInput | null | undefined;
    count?: number | null | undefined;
    keyword?: string | null | undefined;
};
export type SearchArtworksGridTestsQueryResponse = {
    readonly viewer: {
        readonly " $fragmentRefs": FragmentRefs<"SearchArtworksGrid_viewer">;
    } | null;
};
export type SearchArtworksGridTestsQuery = {
    readonly response: SearchArtworksGridTestsQueryResponse;
    readonly variables: SearchArtworksGridTestsQueryVariables;
};
...
query SearchArtworksGridTestsQuery(
  ...
  viewer {
    ...SearchArtworksGrid_viewer_2Y1hcM
  }
}
...
fragment SearchArtworksGrid_viewer_2Y1hcM on Viewer {
  artworks: artworksConnection(first: $count, keyword: $keyword, aggregations: [ARTIST, MEDIUM, PRICE_RANGE, DIMENSION_RANGE, MATERIALS_TERMS, ARTIST_NATIONALITY, LOCATION_CITY, MAJOR_PERIOD, COLOR, PARTNER, FOLLOWED_ARTISTS], input: $input) {
    aggregations {
      slice
      counts {
        count
...
return {
  ...
  "params": {
    "id": "29a5b6adcfcd3d350400fd3573655897",
    "metadata": {
      "relayTestingSelectionTypeInfo": {
        ...
        "viewer.artworks.__isArtworkConnectionInterface": (v9/*: any*/),
        ...
        "viewer.artworks.aggregations.counts.name": (v9/*: any*/),
        "viewer.artworks.aggregations.counts.value": (v9/*: any*/),
        ...
        "viewer.artworks.counts.followedArtists": (v10/*: any*/),
        ...
        "viewer.artworks.edges.__isNode": (v9/*: any*/),
        "viewer.artworks.edges.__typename": (v9/*: any*/),
        "viewer.artworks.edges.cursor": (v9/*: any*/),
        "viewer.artworks.edges.id": (v11/*: any*/),
        ...
        "viewer.artworks.edges.node.__typename": (v9/*: any*/),
        "viewer.artworks.edges.node.artistNames": (v12/*: any*/),
        "viewer.artworks.edges.node.date": (v12/*: any*/),
        "viewer.artworks.edges.node.href": (v12/*: any*/),
        "viewer.artworks.edges.node.id": (v11/*: any*/),
        "viewer.artworks.edges.node.image": {
          "enumValues": null,
          "nullable": true,
          "plural": false,
          "type": "Image"
        ...
        "viewer.artworks.edges.node.image.url": (v12/*: any*/),
        "viewer.artworks.edges.node.internalID": (v11/*: any*/),
        ...
        "viewer.artworks.edges.node.partner.id": (v11/*: any*/),
        "viewer.artworks.edges.node.partner.name": (v12/*: any*/),
        ...
        "viewer.artworks.edges.node.sale.displayTimelyAt": (v12/*: any*/),
        "viewer.artworks.edges.node.sale.endAt": (v12/*: any*/),
        "viewer.artworks.edges.node.sale.id": (v11/*: any*/),
        "viewer.artworks.edges.node.sale.isAuction": (v13/*: any*/),
        "viewer.artworks.edges.node.sale.isClosed": (v13/*: any*/),
        ...
        "viewer.artworks.edges.node.saleArtwork.counts.bidderPositions": (v10/*: any*/),
        ...
        "viewer.artworks.edges.node.saleArtwork.currentBid.display": (v12/*: any*/),
        "viewer.artworks.edges.node.saleArtwork.id": (v11/*: any*/),
        "viewer.artworks.edges.node.saleArtwork.lotLabel": (v12/*: any*/),
        "viewer.artworks.edges.node.saleMessage": (v12/*: any*/),
        "viewer.artworks.edges.node.slug": (v11/*: any*/),
        "viewer.artworks.edges.node.title": (v12/*: any*/),
        "viewer.artworks.id": (v11/*: any*/),
        ...
        "viewer.artworks.pageInfo.endCursor": (v12/*: any*/),
        "viewer.artworks.pageInfo.hasNextPage": {
          "enumValues": null,
          "nullable": false,
          "plural": false,
          "type": "Boolean"
        },
        "viewer.artworks.pageInfo.startCursor": (v12/*: any*/)
      }
    },
    "name": "SearchArtworksGridTestsQuery",
    "operationKind": "query",
