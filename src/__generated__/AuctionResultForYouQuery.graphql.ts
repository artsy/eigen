...
/* eslint-disable */
// @ts-nocheck
/* @relayHash e9b85077297b7bdabc7467f9fb635728 */

import { ConcreteRequest } from "relay-runtime";
import { FragmentRefs } from "relay-runtime";
export type AuctionResultForYouQueryVariables = {
    collectionID: string;
    screenWidth?: number | null;
};
export type AuctionResultForYouQueryResponse = {
    readonly collection: {
        readonly " $fragmentRefs": FragmentRefs<"AuctionResultForYou_collection">;
    } | null;
};
export type AuctionResultForYouQuery = {
    readonly response: AuctionResultForYouQueryResponse;
    readonly variables: AuctionResultForYouQueryVariables;
};



/*
query AuctionResultForYouQuery(
  $collectionID: String!
) {
  collection: marketingCollection(slug: $collectionID) {
    ...AuctionResultForYou_collection_2qE49v
    id
  }
}
...
fragment AuctionResultForYou_collection_2qE49v on MarketingCollection {
  id
  slug
  isDepartment
...
return {
  ...
  "params": {
    "id": "e9b85077297b7bdabc7467f9fb635728",
    "metadata": {},
    "name": "AuctionResultForYouQuery",
    "operationKind": "query",
    "text": null
...
(node as any).hash = '5e628b0c7377bc0e9f34ca2b49b322ac';
export default node;
