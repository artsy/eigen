...
export type ShowArtworksRefetchQueryVariables = {
    readonly showID: string;
    readonly medium?: string | null;
    readonly price_range?: string | null;
};
export type ShowArtworksRefetchQueryResponse = {
    readonly show: {
        readonly " $fragmentRefs": ShowArtworks_show$ref;
    } | null;
};
export type ShowArtworksRefetchQuery = {
    readonly response: ShowArtworksRefetchQueryResponse;
    readonly variables: ShowArtworksRefetchQueryVariables;
};



/*
query ShowArtworksRefetchQuery(
  $showID: String!
  $medium: String
  $price_range: String
) {
  show(id: $showID) {
    ...ShowArtworks_show_3zv0k0
    id
  }
}

fragment ShowArtworks_show_3zv0k0 on Show {
  id
  slug
  internalID
  filteredArtworks(size: 0, medium: $medium, priceRange: $price_range, aggregations: [MEDIUM, PRICE_RANGE, TOTAL]) {
...
return {
  ...
  "params": {
    "operationKind": "query",
    "name": "ShowArtworksRefetchQuery",
    "id": "c39b6371977457fedbfc912b05f1bcdc",
    "text": null,
    "metadata": {}
  }
};
})();
(node as any).hash = '98675bc786bb336b7edfb870c245e83c';
export default node;
