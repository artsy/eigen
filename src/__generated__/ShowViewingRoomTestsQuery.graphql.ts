...
export type ShowViewingRoomTestsQueryVariables = {
    showID: string;
};
export type ShowViewingRoomTestsQueryResponse = {
    readonly show: {
        readonly " $fragmentRefs": FragmentRefs<"ShowViewingRoom_show">;
    } | null;
};
export type ShowViewingRoomTestsQuery = {
    readonly response: ShowViewingRoomTestsQueryResponse;
    readonly variables: ShowViewingRoomTestsQueryVariables;
};



/*
query ShowViewingRoomTestsQuery(
  $showID: String!
) {
  show(id: $showID) {
