...
export type ShowContextCardTestsQueryVariables = {
    showID: string;
};
export type ShowContextCardTestsQueryResponse = {
    readonly show: {
        readonly " $fragmentRefs": FragmentRefs<"ShowContextCard_show">;
    } | null;
};
export type ShowContextCardTestsQuery = {
    readonly response: ShowContextCardTestsQueryResponse;
    readonly variables: ShowContextCardTestsQueryVariables;
};



/*
query ShowContextCardTestsQuery(
  $showID: String!
) {
  show(id: $showID) {
