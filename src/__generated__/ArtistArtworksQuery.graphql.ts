...
/* eslint-disable */
// @ts-nocheck
/* @relayHash 030739c0f4e1f615cd0d5bdb0fb20d88 */
...
query ArtistArtworksQuery(
  ...
  node(id: $id) {
    __typename
    ... on Artist {
      ...ArtistArtworks_artist_2uMWCF
    }
    id
  }
}

fragment ArtistArtworks_artist_2uMWCF on Artist {
  id
  slug
  internalID
...
return {
  ...
  "params": {
    "id": "030739c0f4e1f615cd0d5bdb0fb20d88",
    "metadata": {},
    "name": "ArtistArtworksQuery",
    "operationKind": "query",
    "text": null
...
(node as any).hash = '39cd34ee3d9c3c92f64f66cb00343626';
export default node;
