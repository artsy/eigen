...
/* eslint-disable */
// @ts-nocheck
/* @relayHash 187a6f6f8aaf5a01d3781c2763bf3657 */
...
export type ArtworkAutosuggestResultsQueryVariables = {
    count: number;
    cursor?: string | null | undefined;
    keyword?: string | null | undefined;
    input?: FilterArtworksInput | null | undefined;
};
export type ArtworkAutosuggestResultsQueryResponse = {
    readonly viewer: {
        readonly " $fragmentRefs": FragmentRefs<"ArtworkAutosuggestResults_viewer">;
    } | null;
};
export type ArtworkAutosuggestResultsQuery = {
    readonly response: ArtworkAutosuggestResultsQueryResponse;
    readonly variables: ArtworkAutosuggestResultsQueryVariables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "ArtworkAutosuggestResultsQuery",
    "selections": [
      {
        "alias": null,
        "args": null,
  ...
  "params": {
    "id": "187a6f6f8aaf5a01d3781c2763bf3657",
    "metadata": {},
    "name": "ArtworkAutosuggestResultsQuery",
    "operationKind": "query",
    "text": null
...
(node as any).hash = '9ac32db2da690be2ee08e73d2557935b';
export default node;
