...
/* eslint-disable */
// @ts-nocheck
/* @relayHash 468eafe890b76cfe4e9e80743d4673b3 */
...
query CollectionArtworksInfiniteScrollGridQuery(
  ...
  marketingCollection(slug: $id) {
    ...CollectionArtworks_collection_YCAiB
    id
  }
}
...
fragment CollectionArtworks_collection_YCAiB on MarketingCollection {
  isDepartment
  slug
  id
  collectionArtworks: artworksConnection(first: $count, after: $cursor, aggregations: [COLOR, DIMENSION_RANGE, PARTNER, MAJOR_PERIOD, MEDIUM, PRICE_RANGE, MATERIALS_TERMS, ARTIST_NATIONALITY], input: $input) {
    aggregations {
      slice
      counts {
        value
...
return {
  ...
  "params": {
    "id": "468eafe890b76cfe4e9e80743d4673b3",
    "metadata": {},
    "name": "CollectionArtworksInfiniteScrollGridQuery",
    "operationKind": "query",
    "text": null
...
(node as any).hash = '69050d65081a3ddfdc448b5668831b94';
export default node;
