...
/* eslint-disable */
// @ts-nocheck
/* @relayHash 0ede79a83e34a702e61f75c329df9e12 */
...
fragment FairArtworks_fair_6zGp3 on Fair {
  slug
  internalID
  fairArtworks: filterArtworksConnection(first: 30, aggregations: [ARTIST, ARTIST_NATIONALITY, COLOR, DIMENSION_RANGE, FOLLOWED_ARTISTS, LOCATION_CITY, MAJOR_PERIOD, MATERIALS_TERMS, MEDIUM, PARTNER, PRICE_RANGE], input: {includeArtworksByFollowedArtists: true, sort: "-decayed_merch", dimensionRange: "*-*"}) {
    aggregations {
      slice
      counts {
        count
...
return {
    ...
    "selections": [
      {
        ...
        "selections": [
          ...
          (v3/*: any*/),
          {
            ...
            "storageKey": "filterArtworksConnection(aggregations:[\"ARTIST\",\"ARTIST_NATIONALITY\",\"COLOR\",\"DIMENSION_RANGE\",\"FOLLOWED_ARTISTS\",\"LOCATION_CITY\",\"MAJOR_PERIOD\",\"MATERIALS_TERMS\",\"MEDIUM\",\"PARTNER\",\"PRICE_RANGE\"],first:30,input:{\"dimensionRange\":\"*-*\",\"includeArtworksByFollowedArtists\":true,\"sort\":\"-decayed_merch\"})"
          },
          {
            "alias": "fairArtworks",
            "args": (v4/*: any*/),
  ...
  "params": {
    "id": "0ede79a83e34a702e61f75c329df9e12",
    "metadata": {
      "relayTestingSelectionTypeInfo": {
        ...
        "fair.fairArtworks.edges.node.artist.id": (v19/*: any*/),
        "fair.fairArtworks.edges.node.artist.internalID": (v19/*: any*/),
        ...
        "fair.fairArtworks.edges.node.images": {
          "enumValues": null,
          "nullable": true,
          "plural": true,
          "type": "Image"
        },
        "fair.fairArtworks.edges.node.images.isDefault": (v21/*: any*/),
        "fair.fairArtworks.edges.node.images.url": (v20/*: any*/),
        "fair.fairArtworks.edges.node.internalID": (v19/*: any*/),
        "fair.fairArtworks.edges.node.medium": (v20/*: any*/),
