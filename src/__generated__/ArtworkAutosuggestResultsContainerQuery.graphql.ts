...
/* eslint-disable */
// @ts-nocheck
/* @relayHash ed4c6dda728e567c94b42372d2c34af1 */
...
export type ArtworkAutosuggestResultsContainerQueryVariables = {
    count: number;
    cursor?: string | null | undefined;
    keyword?: string | null | undefined;
    input?: FilterArtworksInput | null | undefined;
};
export type ArtworkAutosuggestResultsContainerQueryResponse = {
    readonly viewer: {
        readonly " $fragmentRefs": FragmentRefs<"ArtworkAutosuggestResults_viewer">;
    } | null;
};
export type ArtworkAutosuggestResultsContainerQuery = {
    readonly response: ArtworkAutosuggestResultsContainerQueryResponse;
    readonly variables: ArtworkAutosuggestResultsContainerQueryVariables;
};
...
query ArtworkAutosuggestResultsContainerQuery(
  ...
  viewer {
    ...ArtworkAutosuggestResults_viewer_wRDQt
  }
}

fragment ArtworkAutosuggestResults_viewer_wRDQt on Viewer {
...
return {
    ...
    "selections": [
      {
        ...
        "selections": [
          ...
          },
          {
            ...
            "handle": "connection",
            "key": "ArtworkAutosuggestResults_artworks",
            "kind": "LinkedHandle",
            "name": "artworksConnection"
          }
        ],
  ...
  "params": {
    "id": "ed4c6dda728e567c94b42372d2c34af1",
    "metadata": {},
    "name": "ArtworkAutosuggestResultsContainerQuery",
    "operationKind": "query",
    "text": null
...
(node as any).hash = '2ae9257973910c99bd2e3e70d2efd61c';
export default node;
