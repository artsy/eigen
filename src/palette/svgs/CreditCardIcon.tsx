...
const VisaIcon = () => (
  <>
    <G fill="none" fillRule="evenodd">
      <Rect stroke="#E5E5E5" fill="#EFEFEF" x=".5" y=".5" width="29" height="19" rx="2" />
      <Path d="M0 14v4.002C0 19.106.898 20 1.992 20h26.016c1.1 0 1.992-.898 1.992-1.998V14H0z" fill="#FFB44F" />
      <Path d="M1.992 0C.892 0 0 .898 0 1.998V6h30V1.998A1.999 1.999 0 0 0 28.008 0H1.992z" fill="#4287CB" />
    </G>
  </>
)
