    ...
    <Box {...rest}>
      ...
      >
        <Box flex={2} bg="black10">
          <OpaqueImageView imageURL={images[0]} style={{ flex: 1, width: "100%" }} />
        </Box>
        ...
        <Box flex={1}>
          ...
          {!!images[1] && <OpaqueImageView imageURL={images[1]} style={{ flex: 1, width: "100%" }} />}

          {!!images[2] && (
            <>
              <Spacer mt="2px" />
              <OpaqueImageView imageURL={images[2]} style={{ flex: 1, width: "100%" }} />
            </>
          )}
        </Box>
      </Box>
