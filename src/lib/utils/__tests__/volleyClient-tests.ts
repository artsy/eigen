...
describe("volleyClient", () => {
  ...
  it("calls fetch with the correct kind of data", async () => {
    ...
    expect(fetch.mock.calls[0][1]).toMatchInlineSnapshot(`
      Object {
        "body": "{\\"serviceName\\":\\"eigen-staging\\",\\"metrics\\":[{\\"type\\":\\"increment\\",\\"name\\":\\"counter\\",\\"tags\\":[\\"device:testDevice\\",\\"network:cellular\\",\\"effective_network:3g\\"]}]}",
        "headers": Object {
  ...
  it("batches metrics", async () => {
    ...
    expect(fetch.mock.calls[0][1]).toMatchInlineSnapshot(`
      Object {
        "body": "{\\"serviceName\\":\\"eigen-staging\\",\\"metrics\\":[{\\"type\\":\\"increment\\",\\"name\\":\\"counter one\\",\\"tags\\":[\\"device:testDevice\\",\\"network:cellular\\",\\"effective_network:3g\\"]},{\\"type\\":\\"increment\\",\\"name\\":\\"counter two\\",\\"tags\\":[\\"device:testDevice\\",\\"network:cellular\\",\\"effective_network:3g\\"]},{\\"type\\":\\"decrement\\",\\"name\\":\\"counter one\\",\\"tags\\":[\\"device:testDevice\\",\\"network:cellular\\",\\"effective_network:3g\\"]}]}",
        "headers": Object {
          "Content-Type": "application/json",
        },
        "method": "POST",
