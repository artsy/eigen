...
it("tracks request condition report tapped", () => {
  ...
  const requestConditionReportComponent = __deprecated_mountWithWrappers(<RequestConditionReportTracking />)
...
it("tracks request condition report success", async () => {
  ...
  const trackingComponent = __deprecated_mountWithWrappers(<RequestConditionReportTracking />)
