...
import { ConfirmContactInfoQueryRenderer } from "../Screens/ConfirmContactInfo"

export const ConsignmentsSubmissionForm: React.FC = () => {
  return (
    <View style={{ flex: 1 }}>
      <NavigatorIOS
        // initialRoute={{ component: Overview }}
        initialRoute={{ component: ConfirmContactInfoQueryRenderer }}
