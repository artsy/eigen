...
const MySettings: React.FC<{ me: MyProfile_me; relay: RelayRefetchProp }> = ({ me, relay }) => {
...
export const MySettingsPlaceholder: React.FC<{}> = () => (
  <Flex pt="3" px="2">
...
export const MySettingsContainer = createRefetchContainer(
  MySettings,
  {
    me: graphql`
      fragment MySettings_me on Me {
        name
        labFeatures
        followsAndSaves {
...
export const MySettingsQueryRenderer: React.FC<{}> = ({}) => (
  <ProvideScreenTrackingWithCohesionSchema info={screen({ context_screen_owner_type: OwnerType.profile })}>
    <QueryRenderer<MyProfileQuery>
      ...
      render={renderWithPlaceholder({
        Container: MySettingsContainer,
        renderPlaceholder: () => <MySettingsPlaceholder />,
      })}
      variables={{}}
    />
