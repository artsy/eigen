...
import { MyCollectionAndSavedWorksQueryRenderer } from "./Scenes/MyProfile/MyCollectionAndSavedWorks"
...
export const modules = defineModules({
  ...
  MyProfile: reactModule(MyCollectionAndSavedWorksQueryRenderer, {
