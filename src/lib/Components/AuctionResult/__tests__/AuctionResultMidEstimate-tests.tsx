...
describe("AuctionResultMidEstimate", () => {
  it("renders properly when the percentage is greater than 5", () => {
    const tree = renderWithWrappers(<AuctionResultsMidEstimate value="25%" shortDescription="mid-estimate" />)
  ...
  it("renders properly when the percentage is between -5 and 5", () => {
    const instance1 = renderWithWrappers(<AuctionResultsMidEstimate value="2%" shortDescription="mid-estimate" />)
    const instance2 = renderWithWrappers(<AuctionResultsMidEstimate value="2%" shortDescription="mid-estimate" />)
    const instance3 = renderWithWrappers(<AuctionResultsMidEstimate value="-2%" shortDescription="mid-estimate" />)
