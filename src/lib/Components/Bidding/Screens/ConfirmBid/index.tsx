...
import { getCurrentEmissionState, unsafe_getEmissionOption } from "lib/store/GlobalStore"
...
export class ConfirmBid extends React.Component<ConfirmBidProps, ConfirmBidState> {
  ...
  render() {
    ...
    const enablePriceTransparency = unsafe_getEmissionOption("AROptionsPriceTransparency")
