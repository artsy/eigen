...
describe(cleanUserPhoneNumber, () => {
  it("handles +-prefixed numbers correctly", () => {
    expect(cleanUserPhoneNumber("+33 32423 5342")).toEqual({ countryCode: "fr", phoneNumber: "32423 5342" })
  ...
  it("handles intenrantional dialing prefixes for different countries", () => {
    ...
    ;(getCountry as jest.Mock).mockReturnValueOnce("US")
    expect(cleanUserPhoneNumber("0111(555)-823-394")).toEqual({ countryCode: "us", phoneNumber: "(555)-823-394" })
