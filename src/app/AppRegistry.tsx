...
import { CareerHightlightsCards } from "./Scenes/MyCollection/Screens/Insights/CareerHightlighsCards"
...
export const modules = defineModules({
  ...
  CareerHightlightsCards: reactModule(CareerHightlightsCards),
