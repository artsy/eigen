...
function getDomainMap(): Record<string, RouteMatcher[] | null> {
  ...
  const artsyDotNet: RouteMatcher[] = compact([
    ...
    addRoute("/collector-profile", "CollectorProfile"),
    ...
    addRoute("/collector-profile/payment", "CollectorProfilePayment"),
    addRoute("/collector-profile/payment/new-card", "CollectorProfilePaymentNewCreditCard"),
    addRoute("/collector-profile/push-notifications", "CollectorProfilePushNotifications"),
    addRoute("/collector-profile/saved-addresses", "SavedAddresses"),
    addRoute("/collector-profile/saved-addresses/new-address", "SavedAddressesForm"),
    addRoute("/collector-profile/saved-addresses/edit-address", "SavedAddressesForm"),
    addRoute("/collector-profile/settings", "CollectorProfileSettings"),
    ...
    addRoute("/collector-profile/saved-search-alerts", "SavedSearchAlertsList"),
    addRoute("/collector-profile/saved-search-alerts/:savedSearchAlertId", "EditSavedSearchAlert"),
