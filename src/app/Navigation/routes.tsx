...
import { SalesAuctionsOverviewScreenQuery } from "app/Scenes/Sales/Components/SalesAuctionsOverview"
...
export const artsyDotNetRoutes = defineRoutes([
  ...
  },
  {
    ...
    queries: [SalesAuctionsOverviewScreenQuery],
  },
  {
  ...
  },
  {
    ...
    options: {
      screenOptions: {
        ...
        header: () => {
          // This is needed to make sure we don't intercept any clicks here accidentally
