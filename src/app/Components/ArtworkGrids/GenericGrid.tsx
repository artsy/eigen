...
import { usePageableArtworks, PageableArtworksEvents } from "app/utils/usePageableArtworks"
...
const injectHooks = (Component: typeof GenericArtworksGrid) => (props: Props) => {
  const { enablePageableArtworks } = usePageableArtworks({ artworks: props.artworks })
  return <Component {...props} onEnablePageableArtworks={enablePageableArtworks} />
}
