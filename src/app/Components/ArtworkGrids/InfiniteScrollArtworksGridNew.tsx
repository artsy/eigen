...
import { InfiniteScrollArtworksGridNew_connection$data } from "__generated__/InfiniteScrollArtworksGridNew_connection.graphql"
...
interface PrivateProps {
  connection:
    | InfiniteScrollArtworksGridNew_connection$data
...
interface MapperProps extends Omit<PrivateProps, "connection"> {
  connection?: InfiniteScrollArtworksGridNew_connection$data
...
const InfiniteScrollArtworksGridMapper: React.FC<MapperProps & Omit<Props, "isMyCollection">> = ({
  ...
  type TheConnectionType<T> = T extends InfiniteScrollArtworksGridNew_connection$data
    ? InfiniteScrollArtworksGridNew_connection$data
    : InfiniteScrollArtworksGrid_myCollectionConnection$data
...
export const InfiniteScrollArtworksGridContainer = createFragmentContainer(
  ...
  {
    connection: graphql`
      fragment InfiniteScrollArtworksGridNew_connection on ArtworkConnectionInterface
...
export const InfiniteScrollMyCollectionArtworksGridContainer = createFragmentContainer(
  InfiniteScrollArtworksGridMapper,
  {
    myCollectionConnection: graphql`
      fragment InfiniteScrollArtworksGridNew_myCollectionConnection on MyCollectionConnection
