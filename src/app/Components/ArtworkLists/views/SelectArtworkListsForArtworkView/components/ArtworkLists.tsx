...
import { ArtworkListItem } from "app/Components/ArtworkLists/views/SelectArtworkListsForArtworkView/components/ArtworkListItem"
import { ArtworkListsLoadingIndicator } from "app/Components/ArtworkLists/views/SelectArtworkListsForArtworkView/components/ArtworkListsLoadingIndicator"
...
export const ArtworkLists: FC<ArtworkListsProps> = (props) => {
  ...
  const handleLoadMore = () => {
    console.log("[debug] handleLoadMore")
