...
interface ProgressiveOnboardingSignalInterestProps {
  children?: React.ReactNode
}

export const ProgressiveOnboardingSignalInterest: React.FC<ProgressiveOnboardingSignalInterestProps> = ({ children }) => {
  const {
    isDismissed,
