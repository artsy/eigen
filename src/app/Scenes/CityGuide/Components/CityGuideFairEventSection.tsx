...
import { CityGuideFairEventSectionCard } from "app/Scenes/CityGuide/Components/CityGuideFairEventSectionCard"
...
export const CityGuideFairEventSection: React.FC<Props> = ({ citySlug, data }) => {
  ...
  const renderItem = ({ item }) => {
    ...
    return (
      <Box pr={1}>
        <CityGuideFairEventSectionCard fair={fair} />
      </Box>
    )
  }
