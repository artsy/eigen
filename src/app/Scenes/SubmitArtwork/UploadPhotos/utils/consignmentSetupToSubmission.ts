  ...
  omitBy(
    {
      ...
      depth:
        submission.metadata && submission.metadata.depth && submission.metadata.depth.toString(),
      ...
      editionSizeFormatted: submission.editionInfo && submission.editionInfo.size,
