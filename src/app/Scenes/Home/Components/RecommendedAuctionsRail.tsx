...
import { RecommendedAuctionsRail_artworkConnection$key } from "__generated__/RecommendedAuctionsRail_artworkConnection.graphql"
...
interface RecommendedAuctionsRailProps extends ArtworkActionTrackingProps {
  title: string
  artworkConnection: RecommendedAuctionsRail_artworkConnection$key
  isRailVisible: boolean
}

export const RecommendedAuctionsRail: React.FC<RecommendedAuctionsRailProps & RailScrollProps> =
...
const artworksFragment = graphql`
  fragment RecommendedAuctionsRail_artworkConnection on Viewer {
