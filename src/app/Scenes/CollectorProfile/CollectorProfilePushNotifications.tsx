...
import { CollectorProfilePushNotifications_me } from "../../../__generated__/CollectorProfilePushNotifications_me.graphql"
import { CollectorProfilePushNotificationsQuery } from "../../../__generated__/CollectorProfilePushNotificationsQuery.graphql"
...
export const CollectorProfilePushNotifications: React.FC<{
  me: CollectorProfilePushNotifications_me
  ...
  const [userNotificationSettings, setUserNotificationSettings] =
    useState<CollectorProfilePushNotifications_me>(me)
  ...
  const updateNotificationPermissions = useCallback(
    debounce(async (updatedPermissions: CollectorProfilePushNotifications_me) => {
...
const CollectorProfilePushNotificationsContainer = createRefetchContainer(
  CollectorProfilePushNotifications,
  {
    me: graphql`
      fragment CollectorProfilePushNotifications_me on Me {
        receiveLotOpeningSoonNotification
        receiveNewSalesNotification
        receiveNewWorksNotification
        receiveOutbidNotification
  ...
  graphql`
    query CollectorProfilePushNotificationsRefetchQuery {
      me {
        ...CollectorProfilePushNotifications_me
      }
    }
  `
)

export const CollectorProfilePushNotificationsQueryRenderer: React.FC<{}> = ({}) => {
  return (
    <QueryRenderer<CollectorProfilePushNotificationsQuery>
      environment={defaultEnvironment}
      query={graphql`
        query CollectorProfilePushNotificationsQuery {
          me {
            ...CollectorProfilePushNotifications_me
          }
        }
      ...
      render={renderWithPlaceholder({
        Container: CollectorProfilePushNotificationsContainer,
        renderPlaceholder: () => (
          <CollectorProfilePushNotifications isLoading me={{} as any} relay={null as any} />
        ),
      })}
      variables={{}}
    />
