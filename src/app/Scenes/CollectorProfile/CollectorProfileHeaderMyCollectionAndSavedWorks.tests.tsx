<<<<<<< HEAD:src/app/Scenes/MyProfile/MyProfileHeaderMyCollectionAndSavedWorks.tests.tsx
...
=======
import { CollectorProfileHeaderMyCollectionAndSavedWorksTestsQuery } from "__generated__/CollectorProfileHeaderMyCollectionAndSavedWorksTestsQuery.graphql"
...
>>>>>>> 7abc6c353 (Rename everywhere):src/app/Scenes/CollectorProfile/CollectorProfileHeaderMyCollectionAndSavedWorks.tests.tsx
...
import {
  CollectorProfileHeaderMyCollectionAndSavedWorksFragmentContainer,
  LOCAL_PROFILE_ICON_PATH_KEY,
} from "./CollectorProfileHeaderMyCollectionAndSavedWorks"
...
describe("CollectorProfileHeaderMyCollectionAndSavedWorks", () => {
  let mockEnvironment: ReturnType<typeof createMockEnvironment>
  const TestRenderer = () => (
    <QueryRenderer<CollectorProfileHeaderMyCollectionAndSavedWorksTestsQuery>
      environment={mockEnvironment}
      query={graphql`
        query CollectorProfileHeaderMyCollectionAndSavedWorksTestsQuery @relay_test_operation {
          me @optionalField {
      ...
      render={({ props, error }) => {
        if (props?.me) {
          return <CollectorProfileHeaderMyCollectionAndSavedWorksFragmentContainer me={props?.me} />
        } else if (error) {
          console.log(error)
        }
      }}
  ...
  describe("Components of CollectorProfileHeaderMyCollectionAndSavedWorks ", () => {
    ...
    // Header tests
    it("Header Settings onPress navigates to CollectorProfileSettings", () => {
      const { container } = getWrapper()
