...
export const CollectorProfileSettings: React.FC<{}> = () => {
  ...
  return (
    <ScrollView>
      ...
      <MenuItem
        title="Saved Alerts"
        onPress={() => navigate("collector-profile/saved-search-alerts")}
      />
      ...
      <MenuItem title="Payment" onPress={() => navigate("collector-profile/payment")} />
      <Separator my={1} borderColor={separatorColor} />
      {!!darkModeSupport && (
        <>
      ...
      {!!showSavedAddresses && (
        <>
          <MenuItem
            ...
            onPress={() => navigate("collector-profile/saved-addresses")}
          />
          <Separator my={1} borderColor={separatorColor} />
        </>
      )}
      ...
      <MenuItem
        ...
        onPress={() => navigate("collector-profile/push-notifications")}
      />
      <Separator my={1} borderColor={separatorColor} />
