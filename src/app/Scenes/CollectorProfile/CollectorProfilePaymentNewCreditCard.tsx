...
import { __triggerRefresh } from "./CollectorProfilePayment"

import { CollectorProfilePaymentNewCreditCardSaveCardMutation } from "__generated__/CollectorProfilePaymentNewCreditCardSaveCardMutation.graphql"
...
export const CollectorProfilePaymentNewCreditCard: React.FC<{}> = ({}) => {
...
const saveCreditCard = (token: string) => {
  return new Promise<CollectorProfilePaymentNewCreditCardSaveCardMutation["response"]>(
    (resolve, reject) => {
      commitMutation<CollectorProfilePaymentNewCreditCardSaveCardMutation>(defaultEnvironment, {
        mutation: graphql`
          mutation CollectorProfilePaymentNewCreditCardSaveCardMutation($input: CreditCardInput!) {
