...
const LANDED_CARD_TARGET_HEIGHT = 38
export const FLIGHT_END_SCALE = LANDED_CARD_TARGET_HEIGHT / CARD_HEIGHT

export const LANDED_CARD_WIDTH = CARD_WIDTH * FLIGHT_END_SCALE
export const LANDED_CARD_HEIGHT = CARD_HEIGHT * FLIGHT_END_SCALE
