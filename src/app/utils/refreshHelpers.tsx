...
export const MY_COLLECTION_ARTWORK_REFRESH_KEY = "refreshMyCollectionArtwork"
...
export const refreshMyCollectionArtwork = () => {
  RefreshEvents.emit(MY_COLLECTION_ARTWORK_REFRESH_KEY)
}
