...
["Artsy/View_Controllers/App_Navigation/ARTopMenuViewController+DeveloperExtras.m",
 ...
 "Artsy.xcodeproj/xcshareddata/xcschemes/Artsy.xcscheme"].each do |dev_file|
  fail("Developer Specific file shouldn't be changed, you can skip by adding #known to the PR body") if !declared_known_dev_tools && git.modified_files.include?(dev_file)
end
