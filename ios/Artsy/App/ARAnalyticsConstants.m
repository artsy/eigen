...
NSString *const ARAnalyticsSegmentNativeNotificationReceived = @"Push Notification Received";
NSString *const ARAnalyticsSegmentNativeNotificationTapped = @"Push Notification Tapped";
